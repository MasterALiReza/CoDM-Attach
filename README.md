...
برای نصب خودکار روی سرور Ubuntu 24.04، می‌توانید از اسکریپت آماده استفاده کنید:
...
- نصب پایتون و دیتابیس PostgreSQL
- ساخت کاربر اختصاصی برای ربات
- تنظیم Virtual Environment
- کانفیگ دیتابیس و فایل .env
- راه‌اندازی سرویس systemd برای اجرای دائم
